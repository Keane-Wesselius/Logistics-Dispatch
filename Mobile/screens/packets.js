(function (global, factory) {
  ...
  class Packet {
    ...
    static fromJSONString(jsonString) {
      const jsonObject = parseJSON(jsonString);
      return new Packet(
        tryGet(jsonObject, Constants.TYPE),
  ...
  class LoginPacket extends Packet {
    ...
    static fromJSONString(jsonString) {
      ...
      return new LoginPacket(
        tryGet(jsonObject, Constants.EMAIL),
        tryGet(jsonObject, Constants.PASSWORD)
      );
    }
  }

  class CreateAccountPacket extends Packet {
    constructor(firstname, lastname, email, password, acctype) {
    ...
    static fromJSONString(jsonString) {
      ...
      return new CreateAccountPacket(
        tryGet(jsonObject, Constants.FIRSTNAME).tryGet(
          jsonObject,
          Constants.LASTNAME
        ),
        tryGet(jsonObject, Constants.EMAIL),
  ...
  class AccountCreateFailedPacket extends Packet {
    ...
    static fromJSONString(jsonString) {
      const jsonObject = parseJSON(jsonString);
      return new AccountCreateFailedPacket(
        tryGet(jsonObject, Constants.ERROR_MESSAGE)
      );
    }
  }
  ...
  class AuthenticationFailedPacket extends Packet {
    ...
    static fromJSONString(jsonString) {
      const jsonObject = parseJSON(jsonString);
      return new AuthenticationFailedPacket(
        tryGet(jsonObject, Constants.ERROR_MESSAGE)
      );
    }
  }
  ...
  class RemoveItem extends Packet {
    ...
    static fromJSONString(jsonString) {
      ...
      return new RemoveItem(
        tryGet(jsonObject, ItemValues.ITEM_ID),
        tryGet(jsonObject, Constants.TOKEN)
      );
    }
  }
