...
const HomeScreen = () => {
    ...
    //fake orders
    const orderData = [{id: 1, name: "Food"},{id: 2, name: "car"},{id: 3, name: "shoes"}];
    //const for orders
...
function renderHeader(){
    ...
    <View style = {{flexDirection: 'row', height: 50, marginTop: '5%'}}>
        ...
        <SimpleLineIcons name="menu" size={30} resizeMode = 'contain' color="black" />
        </TouchableOpacity>
        ...
        <TouchableOpacity style = {{width: 50, paddingRight: 20, justifyContent: 'center'}}>
